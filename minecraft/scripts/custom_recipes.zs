...
recipes.addShaped(<minecraft:shears>, [[<tconstruct:knife_blade>.onlyWithTag({Material: "iron"}), null, <tconstruct:knife_blade>.onlyWithTag({Material: "iron"})],[null, <tconstruct:binding>.onlyWithTag({Material: "wood"}), null],[<tconstruct:tool_rod>.onlyWithTag({Material: "wood"}), null, <tconstruct:tool_rod>.onlyWithTag({Material: "wood"})]]);
...
recipes.addShaped(<minecraft:rail>, [[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), null, <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})],[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), <tconstruct:tool_rod>.onlyWithTag({Material: "wood"}), <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})],[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), null, <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})]]);
recipes.addShaped(<minecraft:detector_rail>, [[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), null, <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})],[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), <minecraft:stone_pressure_plate>, <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})],[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), <ore:dustRedstone>, <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})]]);
recipes.addShaped(<minecraft:activator_rail>, [[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), <tconstruct:tool_rod>.onlyWithTag({Material: "wood"}), <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})],[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), <minecraft:redstone_torch>, <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})],[<tconstruct:tool_rod>.onlyWithTag({Material: "iron"}), <tconstruct:tool_rod>.onlyWithTag({Material: "wood"}), <tconstruct:tool_rod>.onlyWithTag({Material: "iron"})]]);
recipes.addShaped(<minecraft:golden_rail>, [[<tconstruct:tool_rod>.onlyWithTag({Material: "electrum"}), null, <tconstruct:tool_rod>.onlyWithTag({Material: "electrum"})],[<tconstruct:tool_rod>.onlyWithTag({Material: "electrum"}), <tconstruct:tool_rod>.onlyWithTag({Material: "wood"}), <tconstruct:tool_rod>.onlyWithTag({Material: "electrum"})],[<tconstruct:tool_rod>.onlyWithTag({Material: "electrum"}), <ore:dustRedstone>, <tconstruct:tool_rod>.onlyWithTag({Material: "electrum"})]]);
...
//additions
recipes.addShaped(<tconstruct:wood_rail>, [[<tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"}), null, <tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"})],[<tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"}), <tconstruct:tool_rod>.onlyWithTag({Material: "wood"}), <tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"})],[<tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"}), null, <tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"})]]);
recipes.addShaped(<tconstruct:wood_rail_trapdoor>, [[<tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"}), null, <tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"})],[<tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"}), <minecraft:trapdoor>, <tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"})],[<tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"}), null, <tconstruct:tough_tool_rod>.onlyWithTag({Material: "wood"})]]);
